...
class SyncPlugin(Protocol):
    ...
    def after(self, wire: BaseWire[P, R], args: tuple, kwargs: dict, result: Any) -> Any: return result
...
class AsyncPlugin(Protocol):
    ...
    async def after(self, wire: AsyncWire[P, R], args: tuple, kwargs: dict, result: Any) -> Any: return result
